...
class CNNMLPNet(nn.Module):
    def __init__(self, params, **kwargs):
        ...
        actions_num 12
        input_shape (16432,)
        params {'name': 'cnn_mlp_network',
                'separate': False,
                'space': {
                  'continuous': {'mu_activation': 'None', 'sigma_activation': 'None', 'mu_init': {'name': 'default'}, 'sigma_init': {'name': 'const_initializer', 'val': 0.0}, 'fixed_sigma': True}},
                'cnn': {
                  'type': 'conv2d',
                  'activation': 'relu',
                  ...
                  'convs': [{'filters': 32, 'kernel_size': 8, 'strides': 4, 'padding': 0},
                            {'filters': 64, 'kernel_size': 5, 'strides': 2, 'padding': 0},
                ...
                'mlp': {
                  ...
                  'initializer': {'name': 'default'},
                  'regularizer': {'name': 'None'}}}
        kwargs {'num_seqs': 1, 'value_size': 1, 'normalize_value': True, 'normalize_input': True}
        """
...
class CNNMLPNetBuilder(NetworkBuilder):
    ...
    def build(self, name, **kwargs):
        return CNNMLPNet(self.params, **kwargs)
