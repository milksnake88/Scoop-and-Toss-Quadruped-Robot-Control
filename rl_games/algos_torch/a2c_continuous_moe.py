...
class A2CMoEAgent(a2c_common.ContinuousA2CBase):
    ...
    def __init__(self, base_name, params):
        ...
        self.actions_low = self.actions_low[:12]
        self.actions_high = self.actions_high[:12]
    ...
    def play_steps(self):
        ...
        for n in range(self.horizon_length):
            ...
            """
            # load experts model
            e1_model = self.load_experts_model(self.e1_params)
            e2_model = self.load_experts_model(self.e2_params)

            e1_checkpoint = self.params['experts']['expert1']['checkpoint']
            e2_checkpoint = self.params['experts']['expert2']['checkpoint']

            self.restore(e1_model, e1_checkpoint)
