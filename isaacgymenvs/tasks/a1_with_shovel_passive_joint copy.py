...
class A1WithShovelPassiveJointCurriculum(VecTask):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        self.curriculum_update = torch.zeros(self.num_envs, dtype=torch.float, device=self.device, requires_grad=False)
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        cam_props.width = 860
        cam_props.height = 570
        cam_props.near_plane = 0.11
        #cam_props.far_plane = 0.5
        cam_props.horizontal_fov = 1.5
    ...
    def post_physics_step(self):
        ...
        fname = os.path.join("a1_with_shovel_images", "piking_throwing_rgb_test1-%04d.png" % (self.progress_buf[0]))
    ...
    def reset_idx(self, env_ids):
        ...
        # curriculum update
        update_ids = torch.where(self.curriculum_update > 5,
        self.prop_init_state[update_ids, 0] += 0.3
        ...
        self.curriculum_update[update_ids] = 0.
