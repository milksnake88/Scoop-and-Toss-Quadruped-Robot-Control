...
class PpoPlayerContinuousMetaControllerHelper(BasePlayer):
    ...
    def run(self):
        ...
        for _ in range(n_games):
            ...
            for n in range(self.max_steps):
                ...
                # discrete
                expert_action = weight * e1_action + (1-weight)*e2_action

                # continuous
                # expert_action = weight[:, 0].unsqueeze(-1)*e1_action + (1-weight[:, 1]).unsqueeze(-1)*e2_action #continous
