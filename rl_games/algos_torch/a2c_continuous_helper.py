...
class A2CContinuousHelperAgent(a2c_common.ContinuousA2CBase):
    ...
    def __init__(self, base_name, params):
        ...
        self.shovel_to_prop_dis = torch.tensor([[0.]], device=self.ppo_device, requires_grad=False)
    ...
    def get_action_values(self, obs, e1_action, e2_action):
        processed_obs = self._preproc_obs(obs['obs'])
        self.model.eval()
        input_dict = {
            'is_train': False,
    ...
    def play_steps(self):
        ...
        for n in range(self.horizon_length):
            ...
            controller_action = self.get_controller_action(self.controller_model, self.obs)
