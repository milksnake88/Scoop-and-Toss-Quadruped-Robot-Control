...
class A1WithShovelEnv(VecTask):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        self.FR_hip_joint_index = self.gym.get_joint_handle(self.envs[0], "a1", "RR_hip_joint")
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        # load a1 asset
        a1_asset_file = "urdf/a1_with_shovel_description/urdf/a1_with_shovel_fixed_joint.urdf"
        ...
        #print(self.dof_names) #['FL_hip_joint', 'FL_thigh_joint', 'FL_calf_joint', 'FR_hip_joint', 'FR_thigh_joint', 'FR_calf_joint', 'RL_hip_joint', 'RL_thigh_joint', 'RL_calf_joint', 'RR_hip_joint', 'RR_thigh_joint', 'RR_calf_joint']
        a1_dof_props = self.gym.get_asset_dof_properties(a1_asset)
        a1_dof_props['driveMode'] = 1 #gymapi.DOF_MODE_POS
        a1_dof_props['stiffness'] = 60.
        a1_dof_props['damping'] = 3.
    ...
    def load_obs_buf_as_tensor(self):
        obs_array = np.load('obs_buf/obs_buf_approaching_fixed.npy')
