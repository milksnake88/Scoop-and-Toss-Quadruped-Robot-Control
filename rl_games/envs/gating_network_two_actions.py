...
class GatingNetTwoActions(nn.Module):
    ...
    def import_objectFactory_builder(self):
        ...
        self.init_facto
        dry.register_builder('orthogonal', lambda **kwargs : _create_initializer(nn.init.orthogonal_,**kwargs))
        self.init_factory.register_builder('default', lambda **kwargs : nn.Identity())


from rl_games.algos_torch.network_builder import NetworkBuilder

class GatingNetTwoActionsBuilder(NetworkBuilder):
    ...
    def build(self, name, **kwargs):
        return GatingNetTwoActions(self.params, **kwargs)
