...
class BlackNoCube(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        for i in range(self.num_dof):
            ...
            a1_dof_props['stiffness'][i] = 50. #60.
            a1_dof_props['damping'][i] = 1. #3.
    ...
    def post_physics_step(self):
        ...
        envs_to_change = torch.where(rand_prob < 0.005)[0]
    ...
    def set_random_goal_velocity(self, env_ids):
        ...
        self.commands[env_ids, :] = velocities  # 목표 속도 업데이트
