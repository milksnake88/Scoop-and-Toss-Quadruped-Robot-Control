...
class A1WithoutShovel(VecTask):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        self.max_episode_length_s = self.cfg["env"]["learn"]["episodeLength_s"] # episode length in seconds
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        # load a1 asset
        a1_asset_file = "urdf/a1_description/urdf/a1.urdf"
    ...
    def compute_observations(self):
        ...
        self.obs_buf[:] = torch.cat((#self.depth_images,
